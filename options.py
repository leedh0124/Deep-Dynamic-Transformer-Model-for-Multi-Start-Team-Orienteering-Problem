...
def get_options(args=None):
    ...
    parser.add_argument('--max_ent', action='store_true', help="Baseline + Maximum Entropy")
    parser.add_argument('--with_replace', action='store_true', help="Samples with replacement")
    parser.add_argument('--num_veh', type=int, default=2, help="Number of vehicles")
    parser.add_argument('--aug_factor', type=int, default=8, help="Instance augmentation")
    parser.add_argument('--batch_size', type=int, default=2, help='Number of instances per batch during training')
    parser.add_argument('--epoch_size', type=int, default=2, help='Number of instances per epoch during training')
