...
from utils_original.tensor_functions import compute_in_batches

from nets.graph_encoder import GraphAttentionEncoder
from torch.nn import DataParallel
from utils_original.beam_search import CachedLookup
from utils_original.functions import sample_many
...
class AttentionModel(nn.Module):
    ...
    def _one_to_many_logits(self, query, glimpse_K, glimpse_V, logit_K, mask):
        ...
        if self.mask_inner:
            ...
            compatibility[mask[None, :, :, None, :].expand_as(compatibility)] = -1e10 #-math.inf
